    ...
    <div className="flex flex-col items-start justify-center min-h-screen">
        ...
        <div className="grid grid-cols-2 gap-3">
            <div className="col-span-6 md:col-auto text-center order-2 md:text-left mt-5 md:mt-0 px-0 md:px-10">
                ...
                <div className="mt-8">
                    <a href="mailto:eliseekn@gmail.com" target='_blank' rel="nofollow noreferrer noopener"><span className="text-5xl"><font-awesome-icon :icon="faEnvelope" /></span></a>
                    <a href="https://linkedin.com/in/eliseekn" target='_blank' rel="nofollow noreferrer noopener"><span className="text-5xl mx-6"><font-awesome-icon :icon="faLinkedin" /></span></a>
                    <a href="https://github.com/eliseekn" target='_blank' rel="nofollow noreferrer noopener"><span className="text-5xl"><font-awesome-icon :icon="faGithub" /></span></a>
                </div>
                
                <div className="flex items-center justify-center md:justify-start mt-10">
                    <button className="text-base md:text-xl md:leading-loose font-semibold bg-transparent text-[#7e97a6] border-2 border-[#7e97a6] hover:bg-[#7e97a6] hover:text-white px-4 py-2 rounded-lg transition-all duration-500" @click="props.setActivePage('Mes projets')" title="Retour">
            ...
            <div className="col-span-6 md:col-auto order-1">
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <button type="button" className="text-base md:text-xl md:leading-loose col-span-full font-semibold bg-transparent text-[#7e97a6] border-2 border-[#7e97a6] hover:bg-[#7e97a6] hover:text-white px-4 py-2 rounded-lg transition-all duration-500" @click="submitContactForm()">
