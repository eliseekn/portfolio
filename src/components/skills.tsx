...
export default function Skills({ activePage, setActivePage }: IProps) {
    return (
        <div className="flex flex-col items-start justify-center min-h-screen">
            <div className="grid grid-cols-3 gap-3">
                <div className="col-span-6 lg:col-auto bg-transparent border-2 border-[#7e97a6] rounded-lg p-4 hover:shadow hover:shadow-[#7e97a6] transition-all duration-500">
                    ...
                    <div className="my-3 md:my-5 text-xl md:text-5xl">
                    ...
                    <p className="text-base md:text-xl md:leading-loose">Je développe des API avec PHP et Node.js, mais également des applications web avec Next.js/React.js et Vue.js.</p>
                </div>

                <div className="col-span-6 lg:col-auto bg-transparent border-2 border-[#7e97a6] rounded-lg p-4 hover:shadow hover:shadow-[#7e97a6] transition-all duration-500">
                    <p className="text-[#7e97a6] mb-5 font-bold text-xl md:text-3xl">Développement WordPress</p>
                ...
                <div className="col-span-6 lg:col-auto bg-transparent border-2 border-[#7e97a6] rounded-lg p-4 hover:shadow hover:shadow-[#7e97a6] transition-all duration-500">
                    <p className="text-[#7e97a6] mb-5 font-bold text-xl md:text-3xl">Développement Mobile</p>
                    ...
                    <p className="text-base md:text-xl md:leading-loose">Je développe des applications mobile multi-plateformes (iOS et Android) avec React Native.</p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center md:justify-start mt-10">
                ...
                <button className="text-base md:text-xl md:leading-loose ml-5 font-semibold bg-transparent text-[#7e97a6] border-2 border-[#7e97a6] hover:bg-[#7e97a6] hover:text-white px-4 py-2 rounded-lg transition-all duration-500" onClick={() => setActivePage('Work')}>
                    Mes réalisations
                </button>
            </div>
        </div>
