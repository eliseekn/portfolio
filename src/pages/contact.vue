<script setup lang="ts">
    ...
    const submitContactForm = () => {
        ...
        if (!new RegExp(/^[^\s@]+@[^\s@]+$/).test(form.value.email)) {
            return alert('Invalid mail address')
        }
        ...
        fetch('https://sheet.best/api/sheets/b0e5f88f-386b-43a3-85f8-dc194a89262f', {
            ...
            .then(() => {
                ...
                alert('Your message has been successfully sent. You will be contacted shortly.')
            })
    }
</script>
...
<template>
    <div class="flex flex-col items-start justify-center min-h-screen">
        <h1 class="mb-5 md:mb-10 font-bold text-3xl md:text-5xl xl:hidden">Contact</h1>
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="col-span-6 md:col-auto text-center order-2 md:text-left mt-5 md:mt-0 px-0 md:px-10 animate-slide-out">
                <p class="text-base md:text-xl md:leading-loose">
                    Please provide as much detail as possible about your requirements so that I can better understand your project.
                </p>
                ...
                <div class="flex items-center justify-center md:justify-start mt-10 xl:hidden">
                    <button class="btn" @click="props.setActivePage('Projects')" title="Back">
            ...
            <div class="col-span-6 md:col-auto order-1">
                <div class="grid grid-cols-2 gap-4">
                    <input type="text" id="name" class="input col-span-full xl:col-auto" placeholder="Name" v-model.lazy="form.name" />
                    <input type="email" id="email" class="input col-span-full xl:col-auto" placeholder="Mail address" v-model.lazy="form.email" />
                    <input type="text" id="subject" class="input col-span-full" placeholder="Object" v-model.lazy="form.subject" />
                    ...
                    <button type="button" class="btn col-span-full" @click="submitContactForm()">
                        <span v-if="form.submitted">Sending...</span>
